      ...
      <header class="header">
        ...
        <nav class="navbar">
          ...
          <div class="navbar__item">
            <a href="#" class="page-render" data-value="ranking">
              <svg>
        ...
        <div class="header__item">
          <a href="#" class="btn btn--ghost page-render" data-value="registration" id="register">Register New Player</a>
          <a href="#" class="btn btn--ghost page-render" data-value="game" id="start">Start Game</a>
...
export function renderPage(page: "about" | "ranking" | "settings" | "game", gameSettings?: { gridSize: 4; cardType: "animal" }): void {
  ...
  if (page === "about") {
    ...
    const users = new UsersStore()._getAllUsers();
